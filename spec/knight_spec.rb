  ...
  describe 'valid_move?' do
    ...
    context 'legal moves' do
      it 'accepts two up and to the right' do
        expect(knight.valid_move?(6, 3, board)).to be true
      end

      it 'accepts two up and to the left' do
        expect(knight.valid_move?(6, 1, board)).to be true
      end

      it 'accepts two down and to the right' do
        expect(knight.valid_move?(2, 3, board)).to be true
      end
      ...
      it 'accepts two right and up' do
        expect(knight.valid_move?(5, 4, board)).to be true
      end

      it 'accepts two right and down' do
        expect(knight.valid_move?(3, 4, board)).to be true
      end
      ...
      it 'accepts two left and down' do
        expect(knight.valid_move?(5, 0, board)).to be true
      end
    end
    ...
    context 'other pieces on the square' do
      ...
      it 'rejects legal move onto square occupied by same piece' do
        ...
        expect(knight.valid_move?(5, 0, board)).to be false
      end
